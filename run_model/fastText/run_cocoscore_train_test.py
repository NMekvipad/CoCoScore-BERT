...
repeats = 3
ft_train_path = '/home/projects/jensenlab/people/nutmek/alex_data/new_split/' \
                'final_train_test/sentences_labels_9606_-26.txt'

ft_test_path = '/home/projects/jensenlab/people/nutmek/alex_data/new_split/' \
               'final_train_test/sentence_9606_-26_test.txt'
test_path = '/home/projects/jensenlab/people/nutmek/alex_data/new_split/' \
            'final_train_test/dataset_9606_-26_test_10k_alex.tsv.gz'
...
for i in range(repeats):
    model_file = fasttext_fit(ft_train_path, ft_params, fasttext_path, thread=ft_threads,
                              compress_model=True,
